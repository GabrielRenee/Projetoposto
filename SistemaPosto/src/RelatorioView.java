...
public class RelatorioView extends JFrame implements ActionListener {
    ...
    public RelatorioView() {
        ...
        txtVendas.setText("Combustíveis vendidos:\n\n"
                ...
                + " ------------------------------------------------------------------------\n"
                + "Serviços vendidos:\n\n"
                + "Café ---------------------------------------------  " + SistemaControl.objPosto.servicos[0] + " | R$" + rs.format(SistemaControl.objPosto.servicos[0] * 2.00) + "\n"
                + "Salgado -----------------------------------------  " + SistemaControl.objPosto.servicos[1] + " | R$" + rs.format(SistemaControl.objPosto.servicos[1] * 4.00) + "\n"
                + "Ducha Ecológica --------------------------------  " + SistemaControl.objPosto.servicos[2] + " | R$" + rs.format(SistemaControl.objPosto.servicos[2] * 8.00) + "\n"
                + "Balanceamento ---------------------------------  " + SistemaControl.objPosto.servicos[3] + " | R$" + rs.format(SistemaControl.objPosto.servicos[3] * 35.00) + "\n"
                + "Troca de óleo -----------------------------------  " + SistemaControl.objPosto.servicos[4] + " | R$" + rs.format(SistemaControl.objPosto.servicos[4] * 50.00) + "\n"
    ...
    public void actionPerformed(ActionEvent evt) {
        if (evt.getSource() == btnVolta) {
            ...
            btnVolta.setBounds(37, 515, 100, 30);
